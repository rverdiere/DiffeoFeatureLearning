...
for k in range(nb_runs):
    ...
    g,loss = train_featuremap(g, dataloader, loss_function, max_epoch=max_epochs_g, learning_rate=learning_rate, print_freq=printfreq, sig=sig_KL, lamb_KL=lamb_KL)
